...
save "J:\WORK\01_covariates\02_inputs\water_sanitation\hygiene\data\prevalence\DHS/dhs_raw.dta", replace
...
gen indic_station = 1 if inlist(station,-9986,-9988,-9996,-9997,-9990)
replace indic_station = 0 if !inlist(station,-9994, -9991) & indic_station == .

// generate water indicator
gen indic_water = 1 if inlist(water,-9996,-9994)
replace indic_water = 0 if inlist(water,-9997,-9995)

// generate soap indicator
gen indic_soap = 1 if soap == -9997
replace indic_soap = 0 if soap == -9998
...
// for all households
	preserve
		...
		bysort file: subpop handwashing, replace
...
// save tabulated data
use `tabulated', clear
save "J:\WORK\01_covariates\02_inputs\water_sanitation\hygiene\data\prevalence/DHS/dhs_all_tab.dta", replace

use `tabulated_under_5', clear
save "J:\WORK\01_covariates\02_inputs\water_sanitation\hygiene\data\prevalence/DHS/dhs_under_5_tab.dta", replace

use `tabulated_m', clear
save "J:\WORK\01_covariates\02_inputs\water_sanitation\hygiene\data\prevalence/DHS/dhs_all_m_tab.dta", replace

use `tabulated_m_under_5', clear
save "J:\WORK\01_covariates\02_inputs\water_sanitation\hygiene\data\prevalence/DHS/dhs_under_5_m_tab.dta", replace
