...
work_dir <- paste0(i_drive,"/RTs_and_Projects/GBD/Teams/Pooled cohorts and CC/Causal criteria/cleaning and analysis")
setwd(work_dir)

path <- "/WORK/05_risk/risks/wash_hygiene/data/rr/causation_criteria/CC_wgodwin_handwashing_Dec23_2017_valid.xlsm"
#path <- "/WORK/05_risk/risks/wash_sanitation/data/rr/causation_criteria/CC_wash_sanitation_wgodwin_Jan2_2017.xlsm"
