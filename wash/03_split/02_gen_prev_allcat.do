...
// Additional Comments: 
// to run: do /snfs2/HOME/wgodwin/risk_factors2/water/code/03_final_prep/02_gen_prev_allcat.do
//Set directories
	if c(os) == "Unix" {
		global j "/home/j"
		set more off
...
/*
// Assume 100% of high-quality piped households in high-income are treated
forvalues n = 0/999 {
	replace prev_piped_t_`n' = prev_piped_t_`n' + prev_imp_t2_`n' + prev_piped_untr_`n' if super_region_id == 64
	replace prev_piped_untr_`n' = 0 if super_region_id == 64
	replace prev_piped_t2_`n' = 0 if super_region_id == 64
}
