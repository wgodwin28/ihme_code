// File Name: quibb_std_burkina faso_2007.do

// File Purpose: Create standardized dataset with desired variables from QUIBB Burkina Faso 2007 Survey
...
local dat_folder "J:\DATA\WB_CWIQ\BFA\2007"
...
** water, sanitation dataset
	use "`dat_folder'/BFA_CWIQ_2007_HOUSEHOLD.DTA", clear
	tempfile hhserv
	save `hhserv', replace
		** folio
...
save "quibb_burkina faso_2007", replace
