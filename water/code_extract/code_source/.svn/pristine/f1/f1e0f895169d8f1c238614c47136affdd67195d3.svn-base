// File Name: susenas_std_indonesia_2009.do

// File Purpose: Create standardized dataset with desired variables from SUSENAS Indonesia 2009 survey
...
local dat_folder "J:\DATA\IDN\SOCIOECONOMIC_SURVEY_SUSENAS\2009"
local dat_folder_other_merged "${data_folder}/Other/Merged Original Files"
local codes_folder "J:/Usable/Common Indicators/Country Codes"


** water, sanitation dataset
	use "`dat_folder'/IDN_SOCIOECONOMIC_SURVEY_SUSENAS_2009_JULY_CORE_HH.DTA", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
...
label define wsource 1 "branded bottled water" 2 "Water refill" 3 "tap water meter" 4 "tap retail" ///
	5 "drill wells / pumps"	6 "well protected" 7 "unprotected wells" 8 "springs protected" ///
	9 "spring unprotected" 10 "river water" 11 "Precipitation" 12 "Others"
...
label variable wert29 "weight"


** save
cd "`dat_folder_other_merged'"
save "susenas_indonesia_2009", replace
