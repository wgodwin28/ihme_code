// File Name: susenas_std_indonesia_2001.do

// File Purpose: Create standardized dataset with desired variables from SUSENAS Indonesia 2001 survey
...
local dat_folder_country "2001"



** water, sanitation dataset
	use "`dat_folder_survey'/`dat_folder_country'/IDN_SOCIOECONOMIC_SURVEY_SUSENAS_2001_CORE_HH", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
...
** apply labels
label variable k6r6a "water source"
destring k6r6a, replace
...
label values k6r6a wsource

label variable k6r9a "toilet shared"
destring k6r9a, replace
label define tshare 1 "private" 2 "shared" 3 "public" 4 "other"
label values k6r9a tshare

label variable k6r9b "toilet type"
destring k6r9b, replace
label define ttype  1 "capped septic tank/western toiliet" 2 "unsealed tank or pit" 3 "pit or hole" 4 "don't use a toilet"
label values k6r9b ttype

label variable k6r9c "toilet disposal"
destring k6r9c, replace
label define tdisp 1 "septic tank" 2 "pond/field rice" 3 "river/lake/ocean" 4 "hole" 5 "shore/open field" 6 "other"
label values k6r9c tdisp

gen ttype = .
replace ttype = 1 if k6r9b == 1
replace ttype = 2 if k6r9b == 2
replace ttype = 3 if k6r9b == 3
replace ttype = 4 if k6r9b == 4 & k6r9c == 1
replace ttype = 5 if k6r9b == 4 & k6r9c != 1
...
label variable wert01 "weight"


** save
cd "`dat_folder_other_merged'"
save "susenas_indonesia_2001", replace
