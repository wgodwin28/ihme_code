// File Name: hbs_std_tanzania_2000.do

// File Purpose: Create standardized dataset with desired variables from Household Budget Survey Tanzania 2000
...
local dat_folder "J:\DATA\TZA\HH_BUDGET_SURVEY\2000_2001"
...
** water, sanitation dataset
	use "`dat_folder'/TZA_HBS_2000_2001_HH_EXPORT1_Y2010M10D06.DTA", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
...
save "hbs_tanzania_2000", replace
