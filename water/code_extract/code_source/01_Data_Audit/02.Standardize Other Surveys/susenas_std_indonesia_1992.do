// File Name: susenas_std_indonesia_1992.do
...
local dat_folder_country "1992"



** water, sanitation dataset
	use "`dat_folder_survey'/`dat_folder_country'/IDN_SOCIOECONOMIC_SURVEY_SUSENAS_1992_CORE_HH.DTA", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
...
** apply labels
label variable kb8r7 "water source"
destring kb8r7, replace
...
label values kb8r7 wsource

label variable kb8r9 "toilet facility"
destring kb8r9, replace
...
save "susenas_indonesia_1992", replace
