...
local dat_folder "J:\DATA\BOL\INTEGRATED_HH_SURVEY_EIH\1993"
local dat_folder_other_merged "${data_folder}/Other/Merged Original Files"
local codes_folder "J:/Usable/Common Indicators/Country Codes"


** water, sanitation dataset
	use "`dat_folder'/BOL_INTEGRATED_HH_SURVEY_EIH_1993_EIH6_INC_HOUSING_Y2011M03D21.DTA", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
