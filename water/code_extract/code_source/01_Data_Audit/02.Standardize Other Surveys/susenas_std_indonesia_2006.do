// File Name: susenas_std_indonesia_2006.do

// File Purpose: Create standardized dataset with desired variables from SUSENAS Indonesia 2006 survey
...
** water, sanitation dataset
	use "`dat_folder_survey'/`dat_folder_country'/IDN_SOCIOECONOMIC_SURVEY_SUSENAS_2006_JULY_CORE_HH", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
...
save "susenas_indonesia_2006", replace
