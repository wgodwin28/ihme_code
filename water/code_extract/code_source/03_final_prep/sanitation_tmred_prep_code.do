//Filename: sanitation_tmred_prep.do
//July 1, 2014
...
//do  "/home/j/WORK/01_covariates/02_inputs/water_sanitation/code/03_final_prep/sanitation_tmred_prep_code.do"
...
//Create variables and format TMRED to match Greg's template
	...
	**generate 1000 draws of TMRED
	forvalues n = 0/999 {
		gen tmred_`n'=.
		replace tmred_`n' = 1 if parameter == "cat6"
		replace tmred_`n' = 0 if parameter != "cat6"
	}
