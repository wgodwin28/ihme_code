...
//do  "/home/j/WORK/01_covariates/02_inputs/water_sanitation/code/03_final_prep/sanitation_exp_prep_code.do"
...
//set relevant locals
	...
	local san_prev_draws  	"$j/WORK/01_covariates/02_inputs/water_sanitation/output_data/risk_factors/newcat_final_prev_san_`date'.dta"
...
//Sanitation Categories - order is based on levels of risk
	...
	**unimproved - handwashing = cat1
	...
	forvalues d = 1/1000 {
		local n = `d'-1
		rename (isewer_`d' iimproved_`d' iunimp_`d') (exp_cat3_`n' exp_cat2_`n' exp_cat1_`n')
		}
