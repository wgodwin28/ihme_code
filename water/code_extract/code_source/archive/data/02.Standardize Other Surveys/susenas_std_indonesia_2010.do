...
local dat_folder "J:\DATA\IDN\SOCIOECONOMIC_SURVEY_SUSENAS\2010"
local dat_folder_other_merged "${data_folder}/Other/Merged Original Files"
local codes_folder "J:/Usable/Common Indicators/Country Codes"


** water, sanitation dataset
	use "`dat_folder'/IDN_SOCIOECONOMIC_SURVEY_SUSENAS_2010_FEB_PANEL_CORE_HH.DTA", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
...
save "susenas_indonesia_2010", replace
