// File Name: cwiq_std_ghana_2003.do

// File Purpose: Create standardized dataset with desired variables from CWIQ Ghana 2003 Survey
...
local dat_folder "J:\DATA\GHA\CORE_WELFARE_INDICATORS_QUESTIONNAIRE_SURVEY\2003"
...
** water, sanitation dataset
	use "`dat_folder'/GHA_CWIQ_2003_HOUSEHOLD.DTA", clear
	tempfile hhserv
	save `hhserv', replace
		** folio
