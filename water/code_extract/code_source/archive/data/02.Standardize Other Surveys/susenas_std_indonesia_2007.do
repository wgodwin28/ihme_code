// File Name: susenas_std_indonesia_2007.do

// File Purpose: Create standardized dataset with desired variables from SUSENAS Indonesia 2007 survey
...
local dat_folder_country "2007"



** water, sanitation dataset
	use "`dat_folder_survey'/`dat_folder_country'/IDN_SOCIOECONOMIC_SURVEY_SUSENAS_2007_JULY_CORE_HH", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
...
label define wsource 1 "bottled water" 2 "tap water" 3 "retail plumber" 4 "pump" 5 "protected well" /// 
	6 "unprotected well" 7 "protected spring" 8 "unprotected spring" 9 "river" 10 "rain water" 11 "other"
...
label variable wert27 "weight"


** save
cd "`dat_folder_other_merged'"
save "susenas_indonesia_2007", replace
