// File Name: enigh_std_mexico_2005.do

// File Purpose: Create standardized dataset with desired variables from ENIGH Mexico 2005 Survey
...
local dat_folder "J:\DATA\MEX\SURVEY_INCOME_AND_HOUSEHOLD_EXPENDITURE_ENIGH\2005"
...
** water, sanitation dataset
	use "`dat_folder'/MEX_ENIGH_2005_HOUSEHOLD.DTA", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
...
save "enigh_mexico_2005", replace
