// File Name: susenas_std_indonesia_2002.do

// File Purpose: Create standardized dataset with desired variables from SUSENAS Indonesia 2002 survey
...
local dat_folder_country "2002"



** water, sanitation dataset
	use "`dat_folder_survey'/`dat_folder_country'/IDN_SOCIOECONOMIC_SURVEY_SUSENAS_2002_CORE_HH", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
...
label variable wert02 "weight"


** save
cd "`dat_folder_other_merged'"
save "susenas_indonesia_2002", replace
