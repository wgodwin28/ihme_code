...
local dat_folder_country "2008"



** water, sanitation dataset
	use "`dat_folder_survey'/`dat_folder_country'/IDN_SOCIOECONOMIC_SURVEY_SUSENAS_2008_JULY_CORE_HH.DTA", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
...
label define wsource 1 "piped in dwelling or on premises" 2 "public tap" 3 "tubed/piped well or borehole" ///
...
label variable wert28 "weight"


** save
cd "`dat_folder_other_merged'"
save "susenas_indonesia_2008", replace
