// File Name: susenas_std_indonesia_1997.do

// File Purpose: Create standardized dataset with desired variables from SUSENAS Indonesia 1997 survey
...
local dat_folder_country "1997"



** water, sanitation dataset
	use "`dat_folder_survey'/`dat_folder_country'/IDN_SOCIOECONOMIC_SURVEY_SUSENAS_1997_CORE_HH", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
...
label variable wert97 "weight"


** save
cd "`dat_folder_other_merged'"
save "susenas_indonesia_1997", replace
