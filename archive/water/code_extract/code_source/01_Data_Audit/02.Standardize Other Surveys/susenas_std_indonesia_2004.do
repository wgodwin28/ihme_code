// File Name: susenas_std_indonesia_2004.do

// File Purpose: Create standardized dataset with desired variables from SUSENAS Indonesia 2004 survey
...
local dat_folder_country "2004"



** water, sanitation dataset
	use "`dat_folder_survey'/`dat_folder_country'/IDN_SOCIOECONOMIC_SURVEY_SUSENAS_2004_CORE_HH", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
...
** apply labels
label variable b6r7a "water source"
destring b6r7a, replace
...
replace ttype = 5 if b6r10b == 4 & b6r10c != 1
...
label variable wert04 "weight"


** save
cd "`dat_folder_other_merged'"
save "susenas_indonesia_2004", replace
