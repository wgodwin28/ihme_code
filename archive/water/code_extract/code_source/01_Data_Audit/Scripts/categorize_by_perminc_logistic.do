...
// Edited on: 10/28/2013 (updated to reflect new file paths)
...
local dat_folder_new_dhs "C:/Users/asthak/Documents/Covariates/Water and Sanitation/data/DHS"
local graph_folder "C:/Users/asthak/Documents/Covariates/Water and Sanitation/graphs/prevalence/ambiguous"
local perminc_type global
...
pdfstart using "`graph_folder'/sources_by_`perminc_type'_perminc_urbelec_logistic_global.pdf"
...
if "`perminc_type'" == "global" {
	drop if (iso3 == "BEN" & startyear == "1996") | (iso3 == "DOM" & startyear == "1996") | ///
		...
		(iso3 == "UZB" & startyear == "1996") | (iso3 == "BFA" & startyear == "2003") | ///
		(iso3 == "CIV" & startyear == "1994")
}
