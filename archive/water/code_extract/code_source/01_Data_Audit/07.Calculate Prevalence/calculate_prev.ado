...
** // DEBUGGING ONLY!
local survey mics3
local dataloc "J:/WORK/01_covariates/02_inputs/water_sanitation/data/01_Data_Audit/MICS"
...
local filenum 1
	...
	if ("`filename'" == "GTM.dta" | "`filename'" == "SVN.dta" | "`filename'" == "BOL_DHS1_1989_HH_Y2008M09D23.DTA" |  "`filename'" == "PRY_RHS_1998_WN.DTA") {
		replace `psu' = 1
	}
	if "`filename'" == "RWA_MIS_2012_2013_HH_Y2014M08D20" {
		di as error YES
		local `psu' = HV001
	}
