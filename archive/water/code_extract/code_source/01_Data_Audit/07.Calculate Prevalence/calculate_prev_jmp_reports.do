...
local jmp_file 	"J:/WORK/01_covariates/02_inputs/water_sanitation/data/01_Data_Audit/JMP2013/output.csv"

** open report data

	// open jmp file
	insheet using "`jmp_file'", clear
	
	
** get data into proper format
	// make sure all variables are filled in
	carryforward country, replace
	replace country = "" if iso3 != ""
