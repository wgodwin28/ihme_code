// File Name: slms_std_pakistan_2001.do
...
local dat_folder "J:\DATA\PAK\SOCIAL_AND_LIVING_MEASUREMENT_SURVEY\2001_2002"
local dat_folder_other_merged "${data_folder}/Other/Merged Original Files"
local codes_folder "J:/Usable/Common Indicators/Country Codes"


** water, sanitation dataset
	use "`dat_folder'/PAK_PIH_HIES_2001_2002_HOUSING.DTA", clear
...
** household weights dataset
	use "`dat_folder'/PAK_PIH_HIES_2001_2002_SAMPLE.DTA", clear
	tempfile hhweight
...
save "slms_pakistan_2001", replace
