// File Name: enigh_std_mexico_1998.do

// File Purpose: Create standardized dataset with desired variables from ENIGH Mexico 1998 Survey
...
local dat_folder "J:\DATA\MEX\SURVEY_INCOME_AND_HOUSEHOLD_EXPENDITURE_ENIGH\1998"
...
** water, sanitation dataset
	use "`dat_folder'/MEX_ENIGH_1998_HOUSEHOLD.DTA", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
...
save "enigh_mexico_1998", replace
