// File Name: susenas_std_indonesia_1995.do
...
** water, sanitation dataset
	use "`dat_folder_survey'/`dat_folder_country'/IDN_SOCIOECONOMIC_SURVEY_SUSENAS_1995_CORE_HH", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
...
label variable inf_rt "weight"

** save
cd "`dat_folder_other_merged'"
save "susenas_indonesia_1995", replace
