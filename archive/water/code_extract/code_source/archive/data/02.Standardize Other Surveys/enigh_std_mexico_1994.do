// File Name: enigh_std_mexico_1994.do

// File Purpose: Create standardized dataset with desired variables from ENIGH Mexico 1994 Survey
...
local dat_folder "J:\DATA\MEX\SURVEY_INCOME_AND_HOUSEHOLD_EXPENDITURE_ENIGH\1994"
...
** water, sanitation dataset
	use "`dat_folder'/MEX_ENIGH_1994_HOUSEHOLD.DTA", clear
	tempfile hhserv
	save `hhserv', replace
		** hhid
...
label define wsource 1 "agua entubada dentro de la vivienda" /// 
	...
	3 "agua de la llave publica" 4 "agua por acarreo (pozo, arroyo, jaguey)" 5 "agua por pipa"
...
save "enigh_mexico_1994", replace
