...
# bash /homes/jfrostad/_code/risks/air_pm/exp/3b_agg.sh

##GLOBAL FILE##
# declare variables
#VERSION=$1
VERSION=1 #final GBD2015 version
DIR="/share/gbd/WORK/05_risk/02_models/02_results/air_ozone/exp/gridded/${VERSION}"
OUTPUT="${DIR}/GLOBAL.csv"
