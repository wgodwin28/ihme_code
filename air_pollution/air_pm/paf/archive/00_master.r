...
# source("/home/j/WORK/05_risk/01_database/02_data/air_pm/04_paf/04_models/code/00_master.r", echo=T)
	
	# System settings
	mycores <- 4
	rshell <- paste0("/home/j/WORK/05_risk/01_database/02_data/air_pm/02_rr/04_models/code/rshell.sh")
	rscript <- "/home/j/WORK/05_risk/01_database/02_data/air_pm/04_paf/04_models/code/01_calculate_paf.r"
