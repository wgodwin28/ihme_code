...
local code_folder		"/snfs2/HOME/wgodwin/risk_factors/air_pollution/air_hap/rr"
...
// ...................................................... YLL RRs (mortality)...................................................................
		...
		import delimited "`ier_dir'/yll_`loc'_`year'.csv", clear
		rename cause acause
...
*******************************************************************************	
/*
	// As of 9/14/12 use EG meta analysis RRs for LC and COPD - same as GBD 2010 because EG group publication reports the same numbers
...
// ...................................................... YLD RRs (morbidity)...................................................................
	...
	//Prep IER output file - IHD, Stroke, and LRI; 
import delimited "`ier_dir'/yld_`loc'_`year'.csv", clear
rename cause acause
// only keep diseases we analyze
...
// May need to add subarachnoid hemorrhage as a cause (497)
gen cause_id=.
...
replace age_group_id = 235 if age_group_id == 24
	...
	// save in appropriate format: by location_id, year, and sex
		foreach s in 1 2 {
			export delimited age_group_id cause_id mortality morbidity parameter rr* using "`out_dir_draws'/rr_`loc'_`year'_`s'.csv" if sex == `s', replace
		}
